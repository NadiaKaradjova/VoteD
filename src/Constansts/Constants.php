...
namespace App\Constansts;


class Constants
{

    const SHORTNAME = ["edt", "edp", "pdt", "parfum", "nail", "e d t", "edc", "lipstick", "perfume", "eyeliner", "powder", "lipliner",
    ...
    const DESCRIPTION = [
        ...
        "EBNAT", "KYBUN", "KILIAN", "OREAL", "DEBORAH", "GIVENCHY", "MAVALA", "PUPA", "LAUDER"
    ];
